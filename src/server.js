...
/* (endpoint de diagnóstico /api/admin/flow-health removido 2026-06-14 tras verificar
   que los 4 triggers son aceptados por Shopify Flow. No dejar abierto un disparador de
   triggers reales con la auth off.) */
